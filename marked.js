...
(function (e, u) {
    ...
    function f(e, u, t) {
        ...
        u &&
            !j.test(t) &&
            ((e = t),
            g[" " + (n = u)] || (Z.test(n) ? (g[" " + n] = n + "/") : (g[" " + n] = E(n, "/", !0))),
            (u = -1 === (n = g[" " + n]).indexOf(":")),
            (t = "//" === e.substring(0, 2) ? (u ? e : n.replace(O, "$1") + e) : "/" === e.charAt(0) ? (u ? e : n.replace(q, "$1") + e) : n + e));
        try {
    ...
    function C(e, u) {
        var t = e
                ...
                .split(/ \|/),
            n = 0;
        if ((t[0].trim() || t.shift(), 0 < t.length && !t[t.length - 1].trim() && t.pop(), t.length > u)) t.splice(u);
    ...
    function x(e, u, t, n) {
        var r = u.href,
            ...
            i = e[1].replace(/\\([\[\]])/g, "$1");
        return "!" !== e[0].charAt(0) ? ((n.state.inLink = !0), (e = { type: "link", raw: t, href: r, title: u, text: i, tokens: n.inlineTokens(i) }), (n.state.inLink = !1), e) : { type: "image", raw: t, href: r, title: u, text: d(i) };
    }
    var b = (function () {
            function e(e) {
            ...
            return (
                ...
                (u.code = function (e) {
                    ...
                    if (e) return (u = e[0].replace(/^ {1,4}/gm, "")), { type: "code", raw: e[0], codeBlockStyle: "indented", text: this.options.pedantic ? u : E(u, "\n") };
                }),
                (u.fences = function (e) {
                    var u,
                        t,
                                ...
                                null === (t = u.match(/^(\s+)(?:```)/))
                                    ...
                                    : ((r = t[1]),
                                      n
                                          ...
                                          .join("\n"))),
                            { type: "code", raw: u, lang: e[2] && e[2].trim().replace(this.rules.inline._escapes, "$1"), text: t }
                        );
                }),
                (u.heading = function (e) {
                    ...
                    if (e)
                        return (
                            (u = e[2].trim()), /#$/.test(u) && ((t = E(u, "#")), (!this.options.pedantic && t && !/ $/.test(t)) || (u = t.trim())), { type: "heading", raw: e[0], depth: e[1].length, text: u, tokens: this.lexer.inline(u) }
                        );
                }),
                (u.hr = function (e) {
                ...
                (u.blockquote = function (e) {
                    ...
                    if (e)
                        return (
                            (u = e[0].replace(/^ *>[ \t]?/gm, "")), (t = this.lexer.state.top), (this.lexer.state.top = !0), (n = this.lexer.blockTokens(u)), (this.lexer.state.top = t), { type: "blockquote", raw: e[0], tokens: n, text: u }
                        );
                }),
                (u.list = function (e) {
                    ...
                    if (u) {
                        var t,
                            ...
                            F = { type: "list", raw: "", ordered: h, start: h ? +f.slice(0, -1) : "", loose: !1, items: [] },
                        ...
                        for (var g = new RegExp("^( {0,3}" + f + ")((?:[\t ][^\\n]*)?(?:\\n|$))"); e && ((p = !1), (u = g.exec(e))) && !this.rules.block.hr.test(e); ) {
                            if (
                                ...
                                (o = e.split("\n", 1)[0]),
                                this.options.pedantic ? ((i = 2), (c = l.trimLeft())) : ((i = u[2].search(/[^ ]/)), (c = l.slice((i = 4 < i ? 1 : i))), (i += u[1].length)),
                                (s = !1),
                                !l && /^ *$/.test(o) && ((t += o + "\n"), (e = e.substring(o.length + 1)), (p = !0)),
                                !p)
                            )
                                for (
                            ...
                            F.loose || (a ? (F.loose = !0) : /\n *\n *$/.test(t) && (a = !0)),
                                ...
                                F.items.push({ type: "list_item", raw: t, task: !!n, checked: r, loose: !1, text: c }),
                                (F.raw += t);
                        }
                ...
                (u.html = function (e) {
                    ...
                    if (e)
                        return (
                            (u = { type: "html", block: !0, raw: e[0], pre: !this.options.sanitizer && ("pre" === e[1] || "script" === e[1] || "style" === e[1]), text: e[0] }),
                            this.options.sanitize && ((e = this.options.sanitizer ? this.options.sanitizer(e[0]) : d(e[0])), (u.type = "paragraph"), (u.text = e), (u.tokens = this.lexer.inline(e))),
                            u
                        );
                }),
                (u.def = function (e) {
                    ...
                    if (e)
                        return (
                            ...
                            { type: "def", tag: u, raw: e[0], href: t, title: n }
                        );
                }),
                (u.table = function (e) {
                    ...
                    if (e) {
                        ...
                        if (u.header.length === u.align.length) {
                            ...
                            for (i = u.header.length, t = 0; t < i; t++) u.header[t].tokens = this.lexer.inline(u.header[t].text);
                            for (i = u.rows.length, t = 0; t < i; t++) for (r = u.rows[t], n = 0; n < r.length; n++) r[n].tokens = this.lexer.inline(r[n].text);
                            return u;
                        }
                    }
                }),
                ...
                (u.paragraph = function (e) {
                    ...
                    if (e) return (u = "\n" === e[1].charAt(e[1].length - 1) ? e[1].slice(0, -1) : e[1]), { type: "paragraph", raw: e[0], text: u, tokens: this.lexer.inline(u) };
                }),
                (u.text = function (e) {
                ...
                (u.link = function (e) {
                    ...
                    if (e) {
                        ...
                        var n,
                            ...
                            r = "";
                        return (
                            this.options.pedantic ? (n = /^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(t)) && ((t = n[1]), (r = n[3])) : (r = e[3] ? e[3].slice(1, -1) : ""),
                            (t = t.trim()),
                            x(
                                e,
                                {
                ...
                (u.reflink = function (e, u) {
                    ...
                    if ((t = (t = this.rules.inline.reflink.exec(e)) || this.rules.inline.nolink.exec(e)))
                        return (e = u[(e = (t[2] || t[1]).replace(/\s+/g, " ")).toLowerCase()]) ? x(t, e, t[0], this.lexer) : { type: "text", raw: (u = t[0].charAt(0)), text: u };
                }),
                ...
                (u.codespan = function (e) {
                    ...
                    if (e) return (n = e[2].replace(/\n/g, " ")), (u = /[^ ]/.test(n)), (t = /^ /.test(n) && / $/.test(n)), (n = d((n = u && t ? n.substring(1, n.length - 1) : n), !0)), { type: "codespan", raw: e[0], text: n };
                }),
                (u.br = function (e) {
                ...
                (u.autolink = function (e, u) {
                    ...
                    if (e) return (u = "@" === e[2] ? "mailto:" + (t = d(this.options.mangle ? u(e[1]) : e[1])) : (t = d(e[1]))), { type: "link", raw: e[0], text: t, href: u, tokens: [{ type: "text", raw: t, text: t }] };
                }),
                (u.url = function (e, u) {
                    var t, n, r, i;
                    if ((t = this.rules.inline.url.exec(e))) {
                        if ("@" === t[2]) r = "mailto:" + (n = d(this.options.mangle ? u(t[0]) : t[0]));
                        else {
                ...
                (u.inlineText = function (e, u) {
                    ...
                    if (e)
                        return (
                            (u = this.lexer.state.inRawBlock ? (this.options.sanitize ? (this.options.sanitizer ? this.options.sanitizer(e[0]) : d(e[0])) : e[0]) : d(this.options.smartypants ? u(e[0]) : e[0])),
                            { type: "text", raw: e[0], text: u }
                        );
                }),
                e
            );
        ...
        w =
            ((B.def = h(B.def).replace("label", B._label).replace("title", B._title).getRegex()),
            (B.bullet = /(?:[*+-]|\d{1,9}[.)])/),
    ...
    function v(e) {
        for (var u, t = "", n = e.length, r = 0; r < n; r++) (u = e.charCodeAt(r)), (t += "&#" + (u = 0.5 < Math.random() ? "x" + u.toString(16) : u) + ";");
        return t;
    }
    (w._uc_punctuation =
        "\\u00A1\\u00A7\\u00AB\\u00B6\\u00B7\\u00BB\\u00BF\\u037E\\u0387\\u055A-\\u055F\\u0589\\u058A\\u05BE\\u05C0\\u05C3\\u05C6\\u05F3\\u05F4\\u0609\\u060A\\u060C\\u060D\\u061B\\u061E\\u061F\\u066A-\\u066D\\u06D4\\u0700-\\u070D\\u07F7-\\u07F9\\u0830-\\u083E\\u085E\\u0964\\u0965\\u0970\\u0AF0\\u0DF4\\u0E4F\\u0E5A\\u0E5B\\u0F04-\\u0F12\\u0F14\\u0F3A-\\u0F3D\\u0F85\\u0FD0-\\u0FD4\\u0FD9\\u0FDA\\u104A-\\u104F\\u10FB\\u1360-\\u1368\\u1400\\u166D\\u166E\\u169B\\u169C\\u16EB-\\u16ED\\u1735\\u1736\\u17D4-\\u17D6\\u17D8-\\u17DA\\u1800-\\u180A\\u1944\\u1945\\u1A1E\\u1A1F\\u1AA0-\\u1AA6\\u1AA8-\\u1AAD\\u1B5A-\\u1B60\\u1BFC-\\u1BFF\\u1C3B-\\u1C3F\\u1C7E\\u1C7F\\u1CC0-\\u1CC7\\u1CD3\\u2010-\\u2027\\u2030-\\u2043\\u2045-\\u2051\\u2053-\\u205E\\u207D\\u207E\\u208D\\u208E\\u2308-\\u230B\\u2329\\u232A\\u2768-\\u2775\\u27C5\\u27C6\\u27E6-\\u27EF\\u2983-\\u2998\\u29D8-\\u29DB\\u29FC\\u29FD\\u2CF9-\\u2CFC\\u2CFE\\u2CFF\\u2D70\\u2E00-\\u2E2E\\u2E30-\\u2E42\\u3001-\\u3003\\u3008-\\u3011\\u3014-\\u301F\\u3030\\u303D\\u30A0\\u30FB\\uA4FE\\uA4FF\\uA60D-\\uA60F\\uA673\\uA67E\\uA6F2-\\uA6F7\\uA874-\\uA877\\uA8CE\\uA8CF\\uA8F8-\\uA8FA\\uA8FC\\uA92E\\uA92F\\uA95F\\uA9C1-\\uA9CD\\uA9DE\\uA9DF\\uAA5C-\\uAA5F\\uAADE\\uAADF\\uAAF0\\uAAF1\\uABEB\\uFD3E\\uFD3F\\uFE10-\\uFE19\\uFE30-\\uFE52\\uFE54-\\uFE61\\uFE63\\uFE68\\uFE6A\\uFE6B\\uFF01-\\uFF03\\uFF05-\\uFF0A\\uFF0C-\\uFF0F\\uFF1A\\uFF1B\\uFF1F\\uFF20\\uFF3B-\\uFF3D\\uFF3F\\uFF5B\\uFF5D\\uFF5F-\\uFF65"),
    ...
    var y = (function () {
            ...
            return (
                    ...
                    for (
                        ...
                        var e = (function () {
                            ...
                            if ((s = D.tokenizer.def(r)))
                                return (
                                    (r = r.substring(s.raw.length)),
                                    !(a = i[i.length - 1]) || ("paragraph" !== a.type && "text" !== a.type)
                            ...
                            if (
                                ...
                                D.options.extensions &&
                                    ...
                                    D.options.extensions.startBlock.forEach(function (e) {
                                        "number" == typeof (n = e.call({ lexer: this }, t)) && 0 <= n && (u = Math.min(u, n));
                                    }),
                                    u < 1 / 0) &&
                                    0 <= u &&
                                    (l = r.substring(0, u + 1)),
                ...
                (n.inline = function (e, u) {
                    return this.inlineQueue.push({ src: e, tokens: (u = void 0 === u ? [] : u) }), u;
                }),
                    ...
                    for (; r; ) {
                        var t = (function () {
                            ...
                            if ((s = c.tokenizer.reflink(r, c.tokens.links)))
                                return (r = r.substring(s.raw.length)), (a = i[i.length - 1]) && "text" === s.type && "text" === a.type ? ((a.raw += s.raw), (a.text += s.text)) : i.push(s), "continue";
                            ...
                            if (
                                ...
                                c.options.extensions &&
                                    ...
                                    0 <= u &&
                                    (l = r.substring(0, u + 1)),
                                (s = c.tokenizer.inlineText(l, P)))
                            )
                                return (r = r.substring(s.raw.length)), "_" !== s.raw.slice(-1) && (D = s.raw.slice(-1)), (o = !0), (a = i[i.length - 1]) && "text" === a.type ? ((a.raw += s.raw), (a.text += s.text)) : i.push(s), "continue";
                            if (r) {
                                var e = "Infinite loop on byte: " + r.charCodeAt(0);
            ...
            return (
                (u.code = function (e, u, t) {
                    var n,
                        u = (u || "").match(/\S*/)[0];
                    return (
                        this.options.highlight && null != (n = this.options.highlight(e, u)) && n !== e && ((t = !0), (e = n)),
                        (e = e.replace(/\n$/, "") + "\n"),
                        ...
                        if (
                            ...
                            switch (o.type) {
                                ...
                                case "code":
                                    ...
                                    continue;
                                case "table":
                                    for (a = D = "", r = o.header.length, t = 0; t < r; t++) a += this.renderer.tablecell(this.parseInline(o.header[t].tokens), { header: !0, align: o.align[t] });
                                    for (D += this.renderer.tablerow(a), l = "", r = o.rows.length, t = 0; t < r; t++) {
                                        for (a = "", i = (s = o.rows[t]).length, n = 0; n < i; n++) a += this.renderer.tablecell(this.parseInline(s[n].tokens), { header: !1, align: o.align[n] });
                                    ...
                                    for (D = o.ordered, E = o.start, c = o.loose, r = o.items.length, l = "", t = 0; t < r; t++)
                                        (F = (h = o.items[t]).checked),
                                            ...
                                            h.task &&
                                                ...
                                                c
                                                    ? 0 < h.tokens.length && "paragraph" === h.tokens[0].type
                                                        ? ((h.tokens[0].text = g + " " + h.tokens[0].text),
                                                          h.tokens[0].tokens && 0 < h.tokens[0].tokens.length && "text" === h.tokens[0].tokens[0].type && (h.tokens[0].tokens[0].text = g + " " + h.tokens[0].tokens[0].text))
                                                        : h.tokens.unshift({ type: "text", text: g })
                                                    : (p += g)),
                                ...
                                case "paragraph":
                                    ...
                                    continue;
                                case "text":
                                    for (l = o.tokens ? this.parseInline(o.tokens) : o.text; C + 1 < k && "text" === e[C + 1].type; ) l += "\n" + ((o = e[++C]).tokens ? this.parseInline(o.tokens) : o.text);
                    ...
                    for (var t, n, r = "", i = e.length, s = 0; s < i; s++)
                        if (
                            ...
                            this.options.extensions &&
                                ...
                                (!1 !== (n = this.options.extensions.renderers[t.type].call({ parser: this }, t)) || !["escape", "html", "link", "image", "strong", "em", "codespan", "br", "del", "text"].includes(t.type)))
                        )
                            r += n || "";
                        else
                            switch (t.type) {
    ...
    function R(f, g) {
        return function (e, t, n) {
                ...
                l =
                    ...
                    function (e) {
                        ...
                        if (((e.message += "\nPlease report this to https://github.com/markedjs/marked."), r))
                            return (u = "<p>An error occurred:</p><pre>" + d(e.message + "", !0) + "</pre>"), i ? Promise.resolve(u) : s ? void s(null, u) : u;
            ...
            if (
                ...
                (u = t) &&
                    !u.silent &&
                    (a && console.warn("marked(): callback is deprecated since version 5.0.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/using_pro#async"),
                    (u.sanitize || u.sanitizer) &&
                        console.warn("marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/#/USING_ADVANCED.md#options"),
                    (!u.highlight && "language-" === u.langPrefix) ||
            ...
            if (t.async)
                return Promise.resolve(t.hooks ? t.hooks.preprocess(e) : e)
                    ...
                    .then(function (e) {
                        return t.walkTokens
                            ? Promise.all(I.walkTokens(e, t.walkTokens)).then(function () {
                                  return e;
                              })
                            : e;
                    })
    ...
    (T.passThroughHooks = new Set(["preprocess", "postprocess"])),
        ...
        (I.use = function () {
            for (var D = I.defaults.extensions || { renderers: {}, childTokens: {} }, e = arguments.length, u = new Array(e), t = 0; t < e; t++) u[t] = arguments[t];
                        ...
                        (s.extensions.forEach(function (r) {
                            ...
                            if (
                                ...
                                D[r.level] ? D[r.level].unshift(r.tokenizer) : (D[r.level] = [r.tokenizer]),
                                    r.start &&
                                        ("block" === r.level ? (D.startBlock ? D.startBlock.push(r.start) : (D.startBlock = [r.start])) : "inline" === r.level && (D.startInline ? D.startInline.push(r.start) : (D.startInline = [r.start])));
                            }
                            ...
                            T.passThroughHooks.has(r)
                                ? (o[r] = function (e) {
                                      return I.defaults.async
                                          ? Promise.resolve(s.hooks[r].call(o, e)).then(function (e) {
                                                return i.call(o, e);
                                            })
                ...
                !(function () {
                    ...
                    switch (((o = o.concat(a.call(I, u))), u.type)) {
                        ...
                        case "list":
                            ...
                            break;
                        default:
                            I.defaults.extensions && I.defaults.extensions.childTokens && I.defaults.extensions.childTokens[u.type]
                                ? I.defaults.extensions.childTokens[u.type].forEach(function (e) {
